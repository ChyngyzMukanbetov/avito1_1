...
insert into addrezz (city_index,house,street,city_id) values ('city_index1','house1','street1',1),('city_index2','house2','street2',2),('city_index3','house3','street3',3),('city_index4','house4','street4',4);
insert into user (activate,activation_code,age,birthday,email,first_name,gender,is_identification,is_using2fa,last_name,password,phone,role,secret,username,address_id,personal_data_id) values
                                                                                                                                                                                             (1,'active_code1',1,'2022-06-01 22:00:00','user1@mail.ru','user1','men',1,1,'user1lastName','$2a$10$s0DR7i2s0llqDlro7U7XRemfKjLCeBd5xrMGAVTdMOG8V7UgmqztG','11111111111','USER','secret1','username1',1,1),
                                                                                                                                                                                             (1,'active_code2',2,'2022-06-02 22:00:00','user2@mail.ru','user2','women',1,1,'user2lastName','$2a$10$s0DR7i2s0llqDlro7U7XRemfKjLCeBd5xrMGAVTdMOG8V7UgmqztG','22222222222','MODERATOR','secret2','username2',2,2),
                                                                                                                                                                                             (1,'active_code1',3,'2022-06-03 22:00:00','user3@mail.ru','user3','men',1,1,'user3lastName','$2a$10$s0DR7i2s0llqDlro7U7XRemfKjLCeBd5xrMGAVTdMOG8V7UgmqztG','33333333333','ADMIN','secret3','username3',3,3),
                                                                                                                                                                                             (1,'active_code1',4,'2022-06-04 22:00:00','user4@mail.ru','user4','women',1,1,'user4lastName','$2a$10$s0DR7i2s0llqDlro7U7XRemfKjLCeBd5xrMGAVTdMOG8V7UgmqztG','44444444444','ANONYMOUS','secret4','username4',4,4);
insert into shop (count,description,email,is_moderate_accept,is_moderated,is_pretended_to_be_deleted,moderated_reject_reason,name,phone,rating,address_id,user_id) values
